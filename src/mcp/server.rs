...
impl McpServer {
    ...
    fn tool_definitions(&self) -> Value {
        json!([
            ...
            {"name": "create_event", "description": "Create an event", "inputSchema": {"type": "object", "properties": {"calendar_id": {"type": "string"}, "title": {"type": "string"}, "start_at": {"type": "string"}, "end_at": {"type": "string"}, "all_day": {"type": "boolean"}, "description": {"type": "string"}, "location": {"type": "string"}, "url": {"type": "string"}, "image_path": {"type": "string"}}, "required": ["calendar_id", "title", "start_at", "end_at"]}},
            {"name": "update_event", "description": "Update an event", "inputSchema": {"type": "object", "properties": {"id": {"type": "string"}, "calendar_id": {"type": "string"}, "title": {"type": "string"}, "start_at": {"type": "string"}, "end_at": {"type": "string"}, "all_day": {"type": "boolean"}, "description": {"type": ["string", "null"]}, "location": {"type": ["string", "null"]}, "url": {"type": ["string", "null"]}, "image_path": {"type": ["string", "null"]}}, "required": ["id"]}},
